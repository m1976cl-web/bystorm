...
class ClientCreate(BaseModel):
    ...
    neck: float = Field(0.0, ge=0)
    shoulder_blade: float = Field(0.0, ge=0)
    chest: float = Field(0.0, ge=0)
    bust: float = Field(0.0, ge=0)
    underbust: float = Field(0.0, ge=0)
    waist: float = Field(0.0, ge=0)
    hips: float = Field(0.0, ge=0)
    thigh: float = Field(0.0, ge=0)
    knee: float = Field(0.0, ge=0)
    calf: float = Field(0.0, ge=0)
    ankle: float = Field(0.0, ge=0)
    shoe_size: float = Field(0.0, ge=0)
    sole_length: float = Field(0.0, ge=0)
    crotch_ankle: float = Field(0.0, ge=0)
    bicep: float = Field(0.0, ge=0)
    elbow: float = Field(0.0, ge=0)
    forearm: float = Field(0.0, ge=0)
    wrist: float = Field(0.0, ge=0)
    palm: float = Field(0.0, ge=0)
    u_seam: float = Field(0.0, ge=0)
    arm_length: float = Field(0.0, ge=0)
